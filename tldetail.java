...
public class tldetail extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnadd.setText("Teacher Leave Details");
        ...
        subtn.setkSelectedColor(new java.awt.Color(255, 255, 0));
        ...
        subtn2.setkSelectedColor(new java.awt.Color(255, 255, 0));
        ...
        subtn4.setkSelectedColor(new java.awt.Color(255, 255, 0));
        ...
        subtn6.setkSelectedColor(new java.awt.Color(255, 255, 0));
            ...
            .addGroup(kGradientPanel1Layout.createSequentialGroup()
                ...
                .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(subtn2, javax.swing.GroupLayout.DEFAULT_SIZE, 226, Short.MAX_VALUE)
                        .addComponent(subtn, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(subtn6, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
    ...
    private void subtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_subtnActionPerformed
        ...
        {
            Conn c = new Conn();
            ResultSet rs = c.stmt.executeQuery("select * from teacherleave where id='"+choice.getSelectedItem()+"'");
            table.setModel(DbUtils.resultSetToTableModel(rs));
        }
        catch(Exception e)
        {
    ...
    private void subtn6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_subtn6ActionPerformed
        ...
        {
            Conn c = new Conn();
            String q = " delete from teacherleave where id='"+choice.getSelectedItem()+"'";
            c.stmt.executeUpdate(q);
            JOptionPane.showMessageDialog(null,"Record Deleted Successfully");
            setVisible(false);
            new tldetail().setVisible(true);
        }
        catch(Exception e)
        {
            e.printStackTrace();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tldetail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
