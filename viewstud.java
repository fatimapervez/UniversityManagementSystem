...
public class viewstud extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnadd.setText("Student Details");
        ...
        subtn5.setkPressedColor(new java.awt.Color(255, 255, 0));
    ...
    private void subtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_subtnActionPerformed
        try {
            Conn c = new Conn();
            ResultSet rs = c.stmt.executeQuery("select * from student where rollno='" + choice.getSelectedItem() + "'");
            table.setModel(DbUtils.resultSetToTableModel(rs));
        }
        catch (Exception e) {
            e.printStackTrace();
    ...
    private void subtn5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_subtn5ActionPerformed
        try {
            Conn c = new Conn();
            String q = " delete from student where rollno='" + choice.getSelectedItem() + "'";
